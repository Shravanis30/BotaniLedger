...
import { 
    ...
    List, FileCheck, BarChart3, PieChart as PieChartIcon 
} from 'lucide-react';
import { 
...
const LabAnalytics = () => {
    const sidebarItems = [
        ...
        { label: 'Quality Analytics', to: '/lab/analytics', icon: Microscope, end: true },
    ];
    ...
    return (
        <div className="flex bg-[#F8FAFC] min-h-screen">
            ...
            <main className="flex-1 ml-64 p-8 animate-in fade-in duration-700">
