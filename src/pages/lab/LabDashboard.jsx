...
import { Microscope, Database, FileCheck, AlertTriangle, List, Upload, ArrowRight, Loader2 } from 'lucide-react';
                                ...
                                {isLoading ? (
                                    ...
                                    batches.map((batch, i) => (
                                        <tr key={batch._id || i} className="group hover:bg-primary/[0.02] transition-colors">
                                            <td className="px-8 py-7 font-mono text-xs font-bold text-primary">
                                                {batch.batchId}
                                            </td>
                                            ...
                                            <td className="px-8 py-7">
                                                <div className="text-xs font-bold text-gray-500 bg-gray-100 px-3 py-1.5 rounded-lg w-fit">
                                            ...
                                            <td className="px-8 py-7 text-right">
                                                <button className="inline-flex items-center gap-2 px-5 py-2.5 bg-primary text-white rounded-xl text-xs font-black uppercase tracking-widest hover:bg-primary-mid transition-all shadow-xl shadow-green-900/10 active:scale-95">
